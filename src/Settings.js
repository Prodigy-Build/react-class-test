          ...
          <table>
            <tbody>
              <tr>
                ...
                <td>
                  <input type="number" min="14" step="1" name="titleFontSize" id="titleFontSize" value={SettingsStore.titleFontSize} />
                </td>
              </tr>
              <tr>
                <td>
                  <label htmlFor="listSpacing">list spacing:</label>
                </td>
                <td>
                  <input type="number" min="0" name="listSpacing" id="listSpacing" value={SettingsStore.listSpacing} />
                </td>
              </tr>
            </tbody>
          </table>
